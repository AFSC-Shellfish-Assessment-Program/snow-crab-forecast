...
This model explains about 53% of the variability in log-transformed immature snow crab abundance for the years 1980-2021 (Fig. 1). 
...
Data and code for reproducing this forecast are publicly available in the "snow-crab-forecast" repository that was published in a stable, date-referenced repository prior to leg 2 of the 2022 bottom trawl survey (\textcolor{blue}{}).
